...
namespace IFeelGoodSalon.Data.Base
{
    ...
    {
        /// <summary>
        /// Creates a new <c>DbContextScope</c>.
        /// </summary>
        ...
        /// </remarks>
        IDbContextScopeAsync Create(DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);

        /// <summary>
        /// Creates a new <c>DbContextScope</c> for read-only queries.
        /// </summary>
        /// <remarks>
        /// By default, the new scope will join the existing ambient scope. This
        /// is what you want in most cases. This ensures that the same DbContext instances
        ...
        /// implications of doing this.
        /// </remarks>
        IReadOnlyDbContextScope CreateReadOnly(DbContextScopeOption joiningOption = DbContextScopeOption.JoinExisting);
        ...
        /// </remarks>
        IDbContextScopeAsync CreateWithTransaction(IsolationLevel isolationLevel);
        ...
        /// and only if you fully understand the implications of doing this.
        /// </remarks>
        IReadOnlyDbContextScope CreateReadOnlyWithTransaction(IsolationLevel isolationLevel);
        ...
        /// would result in multiple threads accesssing the same DbContext instances at the same time.
        /// </remarks>
